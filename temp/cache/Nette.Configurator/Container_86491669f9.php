...
// source: C:\xampp\htdocs\vykazuj\app/config/config.local.neon 

class Container_86491669f9 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_86491669f9 $container)
			{
